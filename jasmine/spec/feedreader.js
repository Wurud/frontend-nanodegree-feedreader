...
$(function() {
  ...
  describe('The menu', function() {
    ...
    // Check if menu-hidden class is visible in the body tag by defult
    ...
    it('display when it is clicked', function() {
      ...
      expect($('.menu-hidden').is(':visible')).toBe(true);
      // When it clicked, .menu-hidden class will be removed
      icon.click();
      expect($('.menu-hidden').is(':visible')).toBe(false);
      icon.click();
      // When it clicked again, .menu-hidden class will be added to the body tag.
      expect($('.menu-hidden').is(':visible')).toBe(true);
    });
